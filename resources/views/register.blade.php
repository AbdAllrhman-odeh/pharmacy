                                    ...
                                    <form method="POST" action="{{ route('login') }}" class="row g-4">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Cashier Name"  name="name">
                                                </div>
                                                @error('name')
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    <div class="input-group-text"><iconify-icon icon="bi:person-fill"></iconify-icon></div>
                                                    <input type="email" class="form-control" placeholder="Cashier Email"  name="email">
                                                </div>
                                                @error('email')
                                                    <span style="color:red;">*{{$message}}</span>
                                                @enderror
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="password" class="form-control" placeholder="Cashier Password" name="password" >
                                                </div>
                                                @error('password')
                                                    <span style="color:red;">*{{$message}}</span>
                                                @enderror
